...
def evaluate(bid_const,ask_const,tickers,df,total):
    df = df
    bid_const = bid_const
    ask_const = ask_const
    ...
    for i in range(len(tickers)):
        xlsx = pd.read_excel('./testdata/temp/B{}A{}/{}_minute60_history_{}_{}.xlsx'.format(bid_const,ask_const,tickers[i],bid_const,ask_const))
